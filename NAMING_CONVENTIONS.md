...
### Site Essentials
- **Definition:** The WordPress MU plugin that implements Basic Modules of the current Wordpress MUPlugin
- **Type:** Product Module name
- **Namespace:** `SiteEssentials\`
- **Status:** Working name (marketing brand TBD)

### CAOS (Content Architecture OS)
- **Definition:** The Possible Branded Name for the Custom SCOS Software (End to end System WordPress (MU)plugin, MCP and External tools that implements SCOS principles
- **Type:** Product name
- **Namespace:** `CAOS\`
- **Status:** Possible Working name (marketing brand TBD)
- **Related:** Site Essentials (the basic modules likely for non content modules )
